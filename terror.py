...
# -----------------------------------------------------------
# Tidak ada author Untuk Sc ini kecuali ./cybersedati
# Update 26 january 2020 21:57
# Thanks For cybersedati, b1m4,fr13nd5
# subscribe to the Cyber ​​channel sedati
# ---------------------------------------------------------------
...
def logo():
	os.system('clear')
	auth=m+'  Author : '+k+'./bimasena321'
	# if you want to add variables and change kitsune variable data, you can add% s to add variables and change them to strings,% d = change data to decimal,% i = change data to me
	return '''
%s╭━┳━╭━╭━╮%s╮╲╲╲╲╲╲%s╔═╗╔═╗╔═╗╔╦╗
%s┃┈┈┈┣▅╋▅┫┃%s╲╲╲╲╲╲%s╚═╗╠═╝╠═╣║║║
%s┃┈┃┈╰━╰━━━━━━╮%s╲╲%s╚═╝╩  ╩ ╩╩ ╩
